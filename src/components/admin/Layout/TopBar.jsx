  ...
  return (
    <header className="flex items-center justify-between bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow px-3 sm:px-6 py-3 mb-8 rounded-xl min-h-[60px]">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <Link 
                     to="/admin/group-data" 
          className="flex items-center gap-2 sm:gap-3 p-2 rounded-lg transition-colors cursor-pointer group"
        >
          <div className="flex-shrink-0 flex items-center justify-center">
            {groupData?.logo ? (
              <img src={groupData.logo} alt="Group Logo" className="h-6 w-6 sm:h-8 sm:w-8 rounded-full object-cover border border-gray-300 dark:border-gray-700 shadow-sm group-hover:shadow-md transition-shadow" />
            ) : (
              <div className="h-6 w-6 sm:h-8 sm:w-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 shadow-sm group-hover:shadow-md transition-shadow">
