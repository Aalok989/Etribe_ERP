...
export default function StatusCards() {
  ...
  const statusData = [
    ...
    },
    {
      ...
      gradient: "bg-white dark:bg-[#1E1E1E]",
      icon: <FiUserX size={32} className="text-emerald-600 dark:text-emerald-400" />, // Adjust icon color for contrast
    ...
    },
    {
      ...
      gradient: "bg-white dark:bg-[#1E1E1E]",
      icon: <FiAlertCircle size={32} className="text-rose-600 dark:text-rose-400" />, // Adjust icon color for contrast
