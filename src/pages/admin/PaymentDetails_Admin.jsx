...
export default function PaymentDetails() {
  ...
  // Default sort by date or id, descending
  ...
  const sortedPayments = [...filteredPayments].sort((a, b) => {
    let aValue = a[sortField] || a["created_at"] || a["updated_at"] || a["id"] || '';
    let bValue = b[sortField] || b["created_at"] || b["updated_at"] || b["id"] || '';
    // If sorting by date or id, sort numerically/chronologically
    if (sortField === "date" || sortField === "created_at" || sortField === "updated_at" || sortField === "id") {
