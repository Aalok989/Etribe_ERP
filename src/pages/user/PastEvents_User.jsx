...
import { FiFileText, FiFile, FiEye, FiX, FiCalendar, FiMapPin, FiClock, FiSearch, FiDownload, FiCopy, FiRefreshCw, FiImage, FiChevronDown, FiArchive, FiChevronLeft, FiChevronRight } from "react-icons/fi";
...
const CACHE_STORAGE_KEY = 'past_events_cache';
...
const setCacheData = (data) => {
  try {
    ...
    console.warn('Failed to cache past events data:', error);
  }
};
...
export default function PastEvents() {
  ...
  const exportToCSV = () => {
    ...
    toast.success("Past events exported to CSV successfully!");
  };
  ...
  const exportToExcel = () => {
    ...
    toast.success("Past events exported to Excel successfully!");
  };
  ...
  const exportToPDF = () => {
    ...
    doc.text("Past Events Report", 14, 15);
      doc.save("past_events.pdf");
    toast.success("Past events exported to PDF successfully!");
  };
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast.success("Past events copied to clipboard!");
    } catch (err) {
      ...
      <DashboardLayout>
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#1E1E1E]">
          <div className="flex items-center gap-3">
            ...
            <p className="text-indigo-700 dark:text-indigo-300">Loading past events...</p>
          </div>
        </div>
      </DashboardLayout>
    );
            ...
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-xl p-8 w-full max-w-lg mx-4 relative">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  View complete past event information
                </p>
              </div>
