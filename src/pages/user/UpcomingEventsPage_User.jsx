...
const CACHE_STORAGE_KEY = 'upcoming_events_cache';
...
const setCacheData = (data) => {
  try {
    ...
    console.warn('Failed to cache upcoming events data:', error);
  }
};
...
export default function UpcomingEventsPage() {
    ...
    try {
        ...
        const mappedEvents = backendEvents.map((e, idx) => ({
          ...
          datetime: e.event_date && e.event_time 
            ...
            ? (e.event_image.startsWith("http") ? e.event_image : BASE_URL + e.imageUrl)
            : e.image || e.imageUrl || "",
        }));
  ...
  const exportToCSV = () => {
    ...
    toast.success("Upcoming events exported to CSV successfully!");
  };
  ...
  const exportToExcel = () => {
    ...
    toast.success("Upcoming events exported to Excel successfully!");
  };
  ...
  const exportToPDF = () => {
    ...
    doc.text("Upcoming Events Report", 14, 15);
    doc.save("upcoming_events.pdf");
    toast.success("Upcoming events exported to PDF successfully!");
  };
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast.success("Upcoming events copied to clipboard!");
    } catch (err) {
            ...
            <button
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  View complete upcoming event information
                </p>
              </div>
