              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                  {Array.from({ length: 10 }).map((_, i) => {
                    ...
                    return (
                      <div key={i} className={`p-3 sm:p-4 rounded-lg border ${isConfigured ? 'bg-gray-50 dark:bg-[#1E1E1E] border-gray-200 dark:border-gray-700' : 'bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 opacity-60'}`}> 
